...
main() {
    ...
    echo "  - NoETL UI:           http://localhost:8083"
    ...
    echo "  3. Register credentials: task test:k8s:register-credentials"
    echo "  4. Register playbooks:   task test:k8s:register-playbooks"
    echo "  5. View server logs:     kubectl logs -n noetl -l app=noetl-server -f"
    echo ""
