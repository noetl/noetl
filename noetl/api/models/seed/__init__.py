...
from api.models.seed.dict_component import seed_dict_component
from api.models.seed.dict_operand import seed_dict_operand
...
async def seed_all(session: AsyncSession) -> None:
    ...
    await seed_flow_transition_csv(session, "api/models/seed/csv")
