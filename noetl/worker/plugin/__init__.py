...
from .loop import execute_loop_task
...
def execute_task(
    ...
    if task_type == 'http':
        ...
        return execute_loop_task(task_config, context, jinja_env, task_with or {}, log_event_callback)
    else:
        raise ValueError(f"Unknown task type '{raw_type}'. Available types: http, python, duckdb, postgres, secrets, playbook, workbook, loop")
