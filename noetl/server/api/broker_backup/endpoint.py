...
# Orchestration function from run package (event-driven orchestrator)
from noetl.server.api.run import evaluate_execution

# TODO: Iterator completions need to be reimplemented in run package
# from noetl.server.api.event_backup.service.iterators import (
...
async def trigger_iterator_completion(execution_id: str):
    ...
    TODO: Reimplement in run package orchestrator
    """
    # TODO: Call orchestrator._check_iterator_completions once implemented
    logger.warning(f"Iterator completion check not yet implemented in new orchestrator for {execution_id}")
    return {
        "status": "not_implemented",
        "message": f"Iterator completion check needs to be reimplemented in run.orchestrator"
    }
