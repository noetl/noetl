...
Semantic Versioning (SemVer) uses MAJOR.MINOR.PATCH (e.g., 2.1.4). The goal of this guide is to make it easy to consistently map your day‑to‑day work (commits and branches) to the correct version bump.
...
- Inline: feat!: migrate to v2 authentication
- Footer:
